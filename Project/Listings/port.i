...
#line 76 "..\\FreeRTOS\\portable\\RVDS\\ARM_CM3\\port.c"
...
#line 77 "..\\FreeRTOS\\portable\\RVDS\\ARM_CM3\\port.c"
...
#line 95 "..\\FreeRTOS\\portable\\RVDS\\ARM_CM3\\port.c"
...
#line 132 "..\\FreeRTOS\\portable\\RVDS\\ARM_CM3\\port.c"
...
BaseType_t xPortStartScheduler( void )
{

	{
		...
		*pucFirstUserPriorityRegister = ( ( uint8_t ) 0xff );
		...
		ucMaxSysCallPriority = ( 0x01 << (8 - 4) ) & ucMaxPriorityValue;
...
#line 604 "..\\FreeRTOS\\portable\\RVDS\\ARM_CM3\\port.c"
...
#line 623 "..\\FreeRTOS\\portable\\RVDS\\ARM_CM3\\port.c"

		 
		( * ( ( volatile uint32_t * ) 0xe000e014 ) ) = ( ( ( unsigned long ) 120000000 ) / ( ( TickType_t ) 1000 ) ) - 1UL;
