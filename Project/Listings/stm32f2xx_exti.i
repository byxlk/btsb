#line 1 "..\\Libraries\\STM32F2xx_StdPeriph_Driver\\src\\stm32f2xx_exti.c"
...
#line 174 "..\\Libraries\\STM32F2xx_StdPeriph_Driver\\inc\\stm32f2xx_exti.h"
...
#line 68 "..\\Libraries\\STM32F2xx_StdPeriph_Driver\\src\\stm32f2xx_exti.c"
...
ITStatus EXTI_GetITStatus(uint32_t EXTI_Line)
{
  ...
  enablestatus =  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->IMR & EXTI_Line;
  if (((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->PR & EXTI_Line) != (uint32_t)RESET) && (enablestatus != (uint32_t)RESET))
  {
    bitstatus = SET;
  }
  else
