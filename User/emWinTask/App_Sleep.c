...
*********************************************************************************************************
*/
WM_HWIN  hWin_Sleep = WM_HWIN_NULL;               /* 音乐播放对话框句柄 */
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreateMusic[] =
{
	...
	{ BUTTON_CreateIndirect, "Sleep",  ID_BUTTON_6,    0,   0,  100, 100, 0, 0, 0 },
...
*********************************************************************************************************
*/
WM_HWIN App_Sleep(WM_HWIN hWin)
{
#if 1
	hWin_Sleep = GUI_CreateDialogBox(_aDialogCreateMusic,
	                                ...
	                                0);
#else
	hWin_Sleep = WM_CreateWindowAsChild(0, 0,
                                  LCD_GetXSize(),
                                  LCD_GetYSize(),
                                  WM_HBKWIN,
