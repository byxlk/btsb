...
#line 53 "..\\Libraries\\STM32F2xx_StdPeriph_Driver\\src\\stm32f2xx_cryp_aes.c"
                         ...
                         uint8_t* Input, uint32_t Ilength, uint8_t* Output)
{
  ...
  if(Mode == ((uint8_t)0x00))  
  {
    ...
    AES_CRYP_InitStructure.CRYP_AlgoMode = ((uint16_t)0x0038);
  ...
  AES_CRYP_InitStructure.CRYP_AlgoMode = ((uint16_t)0x0020);
                         ...
                         uint8_t *Output)
{
  ...
  AES_CRYP_InitStructure.CRYP_AlgoMode = ((uint16_t)0x0028);
  AES_CRYP_InitStructure.CRYP_DataType = ((uint16_t)0x0080);
  CRYP_Init(&AES_CRYP_InitStructure);
                         ...
                         uint8_t *Output)
{
  ...
  AES_CRYP_InitStructure.CRYP_AlgoMode = ((uint16_t)0x0030);
  AES_CRYP_InitStructure.CRYP_DataType = ((uint16_t)0x0080);
  CRYP_Init(&AES_CRYP_InitStructure);
