...
#line 331 "..\\Libraries\\STM32F2xx_StdPeriph_Driver\\inc\\stm32f2xx_flash.h"
...
#line 77 "..\\Libraries\\STM32F2xx_StdPeriph_Driver\\src\\stm32f2xx_flash.c"
...
FLASH_Status FLASH_GetStatus(void)
{
  ...
  {  
    ...
    {
      if((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3C00))->SR & (uint32_t)0xEF) != (uint32_t)0x00)
      {
