...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { FRAMEWIN_CreateIndirect, "Counting...",        0,      30,  80, 400, 190, FRAMEWIN_CF_MOVEABLE },
  { TEXT_CreateIndirect,     "00",        GUI_ID_TEXT0,    10,  10, 120,  80 },
  { RADIO_CreateIndirect,    "",          GUI_ID_RADIO0,  150,  10, 180,  120, 0, 0x1904, 0},
  { BUTTON_CreateIndirect,   "OK",        GUI_ID_OK,       19, 121, 114, 32, 0, 0x0, 0 },
  { BUTTON_CreateIndirect,   "Cancel",    GUI_ID_CANCEL,  252, 120, 116, 35, 0, 0x0, 0 },
};
