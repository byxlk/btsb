...
#line 24 "..\\User\\bsp\\bsp_uart_fifo.c"


 

	static UART_T g_tUart1;
	static uint8_t g_TxBuf1[1*1024];		 
	static uint8_t g_RxBuf1[1*1024];		 
...
void RS485_InitTXE(void)
{
	...
	RCC_APB2PeriphClockCmd(((uint32_t)0x00000002), ENABLE);	 
...
{
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400))->BSRRH = ((uint16_t)0x0004);	 
}
...
{
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400))->BSRRL = ((uint16_t)0x0004);	 
}
...
static void UartVarInit(void)
{
	...
	g_tUart1.uart = ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000));						 
	g_tUart1.pTxBuf = g_TxBuf1;					 
	g_tUart1.pRxBuf = g_RxBuf1;					 
	g_tUart1.usTxBufSize = 1*1024;	 
	g_tUart1.usRxBufSize = 1*1024;	 
...
#line 457 "..\\User\\bsp\\bsp_uart_fifo.c"

#line 474 "..\\User\\bsp\\bsp_uart_fifo.c"

#line 491 "..\\User\\bsp\\bsp_uart_fifo.c"

#line 508 "..\\User\\bsp\\bsp_uart_fifo.c"


#line 526 "..\\User\\bsp\\bsp_uart_fifo.c"
}
...
static void InitHardUart(void)
{
	...
	USART_ClearFlag(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000)), ((uint16_t)0x0040));      


#line 629 "..\\User\\bsp\\bsp_uart_fifo.c"

#line 687 "..\\User\\bsp\\bsp_uart_fifo.c"

#line 729 "..\\User\\bsp\\bsp_uart_fifo.c"

#line 772 "..\\User\\bsp\\bsp_uart_fifo.c"
}
...
#line 806 "..\\User\\bsp\\bsp_uart_fifo.c"

#line 815 "..\\User\\bsp\\bsp_uart_fifo.c"

#line 824 "..\\User\\bsp\\bsp_uart_fifo.c"

#line 833 "..\\User\\bsp\\bsp_uart_fifo.c"

#line 842 "..\\User\\bsp\\bsp_uart_fifo.c"
}
...
#line 884 "..\\User\\bsp\\bsp_uart_fifo.c"
	...
	USART_ITConfig(_pUart->uart, ((uint16_t)0x0727), ENABLE);
}
...
static void UartIRQ(UART_T *_pUart)
{
	...
	if (USART_GetITStatus(_pUart->uart, ((uint16_t)0x0525)) != RESET)
	{
	...
	if (USART_GetITStatus(_pUart->uart, ((uint16_t)0x0727)) != RESET)
	{
		
		if (_pUart->usTxCount == 0)
		{
			 
			USART_ITConfig(_pUart->uart, ((uint16_t)0x0727), DISABLE);

			 
			USART_ITConfig(_pUart->uart, ((uint16_t)0x0626), ENABLE);
		}
		else
		{
	...
	else if (USART_GetITStatus(_pUart->uart, ((uint16_t)0x0626)) != RESET)
	{
		
		if (_pUart->usTxCount == 0)
		{
			 
			USART_ITConfig(_pUart->uart, ((uint16_t)0x0626), DISABLE);
...
#line 1068 "..\\User\\bsp\\bsp_uart_fifo.c"

#line 1075 "..\\User\\bsp\\bsp_uart_fifo.c"

#line 1082 "..\\User\\bsp\\bsp_uart_fifo.c"

#line 1089 "..\\User\\bsp\\bsp_uart_fifo.c"

#line 1096 "..\\User\\bsp\\bsp_uart_fifo.c"
...
int fputc(int ch, FILE *f)
{
	...
	USART_SendData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000)), (uint8_t) ch);

	 
	while (USART_GetFlagStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000)), ((uint16_t)0x0040)) == RESET)
	{}
...
int fgetc(FILE *f)
{
	...
	return ucData;
#line 1146 "..\\User\\bsp\\bsp_uart_fifo.c"
}
