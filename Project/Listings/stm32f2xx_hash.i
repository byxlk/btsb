...
#line 241 "..\\Libraries\\STM32F2xx_StdPeriph_Driver\\inc\\stm32f2xx_hash.h"
...
#line 130 "..\\Libraries\\STM32F2xx_StdPeriph_Driver\\src\\stm32f2xx_hash.c"
#line 131 "..\\Libraries\\STM32F2xx_StdPeriph_Driver\\src\\stm32f2xx_hash.c"
...
void HASH_Init(HASH_InitTypeDef* HASH_InitStruct)
{
  ...
  ((HASH_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x60400))->CR &= ~ (((uint32_t)0x00000080) | ((uint32_t)0x00000030) | ((uint32_t)0x00000040));
  ...
  if(HASH_InitStruct->HASH_AlgoMode == ((uint16_t)0x0040)) 
  {
    ((void)0);
...
void HASH_StructInit(HASH_InitTypeDef* HASH_InitStruct)
{
  ...
  HASH_InitStruct->HASH_AlgoSelection = ((uint16_t)0x0000);

   
  HASH_InitStruct->HASH_AlgoMode = ((uint16_t)0x0000);

   
  HASH_InitStruct->HASH_DataType = ((uint16_t)0x0000);
...
void HASH_ITConfig(uint8_t HASH_IT, FunctionalState NewState)
{
  ...
  else
  {
    ...
    ((HASH_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x60400))->IMR &= (uint8_t) ~HASH_IT;
  }
}
...
FlagStatus HASH_GetFlagStatus(uint16_t HASH_FLAG)
{
  ...
  if ((HASH_FLAG & ((uint16_t)0x1000)) != (uint16_t)RESET ) 
  {
...
void HASH_ClearITPendingBit(uint8_t HASH_IT)
{
  ...
  ((HASH_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x60400))->SR = (uint8_t)~HASH_IT;
}
