...
static void Init_7789(void)
{
        ...
        ST7789V_WriteParam(0x2b);

        ST7789V_WriteCmd(0xc3); 
        ST7789V_WriteParam(0x17); 

        ST7789V_WriteCmd(0xc4); 
        ST7789V_WriteParam(0x20);
        ...
        ST7789V_WriteParam(0xa2);
        
        ST7789V_SetGammaCtrl(); 

         
        ST7789V_WriteCmd(0x13); 
        ST7789V_WriteCmd(0x20); 
        ST7789V_DispOn(); 
...
static void ST7789V_ReadData(uint8_t *readBuf, uint8_t _uCount)
{
	...
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), &GPIO_InitStructure);
        ...
        GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((uint16_t)0x0200)); 

        for(i = 0; i < _uCount; i++)
        {
                GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((uint16_t)0x0040)); 
                GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((uint16_t)0x0040));  
                readBuf[i] = (uint8_t)(GPIO_ReadInputData(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400))) & 0xFF);
        }
...
static void ST7789V_WriteCmd(uint8_t _ucCmd)
{
        ...
        GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((uint16_t)0x0200)); 
        GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((uint16_t)0x0100));  
        GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((uint16_t)0x0080)); 
        
        GPIO_Write(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), (0xff << 8) | _ucCmd);
...
static void ST7789V_WriteParam(uint8_t _ucParam)
{
        ...
        GPIO_Write(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), (0xff << 8) | _ucParam);
...
static void ST7789V_SetDispWin(uint16_t _usX, uint16_t _usY, uint16_t _usHeight, uint16_t _usWidth)
{
	...
	ST7789V_WriteParam((uint8_t)((_usX & 0xFF00) >> 8));	 
	...
	ST7789V_WriteParam((uint8_t)((_usY & 0xFF00) >> 8));    
...
#line 502 "..\\User\\bsp\\bsp_lcd_st7789v.c"
