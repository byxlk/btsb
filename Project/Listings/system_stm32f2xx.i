...
#line 122 "..\\Libraries\\CMSIS\\Device\\ST\\STM32F2xx\\Source\\Templates\\system_stm32f2xx.c"
...
static void SetSysClock(void)
{
  ...
  volatile uint32_t StartUpCounter = 0, HSEStatus = 0, HSIStatus = 0;
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->PLLCFGR = 25 | (240 << 6) | (((2 >> 1) -1) << 16) |
                   (((uint32_t)0x00400000)) | (5 << 24);
    ...
    ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3C00))->ACR = ((uint32_t)0x00000100) | ((uint32_t)0x00000200) | ((uint32_t)0x00000400) | ((uint32_t)0x00000003);
  ...
  { 
    ...
    do
    {
        HSIStatus = ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CR & ((uint32_t)0x00000002);
        StartUpCounter++;
    } while((HSIStatus == 0) && (StartUpCounter != ((uint16_t)0x0500)));
    ...
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->PLLCFGR = 16 | (240 << 6) | (((2 >> 1) -1) << 16) | (5 << 24);
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->PLLCFGR &= ~((uint32_t)0x1 << 22);
...
#line 567 "..\\Libraries\\CMSIS\\Device\\ST\\STM32F2xx\\Source\\Templates\\system_stm32f2xx.c"
