...
#line 21 "..\\User\\bsp\\bsp_tim_pwm.c"
...
{
        if(GPIOx == ((uint16_t)0x0001)) return ((uint8_t)0x00);
        else if(GPIOx == ((uint16_t)0x0002)) return ((uint8_t)0x01);
        else if(GPIOx == ((uint16_t)0x0004)) return ((uint8_t)0x02);
        else if(GPIOx == ((uint16_t)0x0008)) return ((uint8_t)0x03);
        else if(GPIOx == ((uint16_t)0x0010)) return ((uint8_t)0x04);
        else if(GPIOx == ((uint16_t)0x0020)) return ((uint8_t)0x05);
        else if(GPIOx == ((uint16_t)0x0040)) return ((uint8_t)0x06);
        else if(GPIOx == ((uint16_t)0x0080)) return ((uint8_t)0x07);
        else if(GPIOx == ((uint16_t)0x0100)) return ((uint8_t)0x08);
        else if(GPIOx == ((uint16_t)0x0200)) return ((uint8_t)0x09);
        else if(GPIOx == ((uint16_t)0x0400)) return ((uint8_t)0x0A);
        else if(GPIOx == ((uint16_t)0x0800)) return ((uint8_t)0x0B);
        else if(GPIOx == ((uint16_t)0x1000)) return ((uint8_t)0x0C);
        else if(GPIOx == ((uint16_t)0x2000)) return ((uint8_t)0x0D);
        else if(GPIOx == ((uint16_t)0x4000)) return ((uint8_t)0x0E);
        else return ((uint8_t)0x0F);
}

uint8_t bsp_GetGpioAfTIMx(TIM_TypeDef* TIMx)
{
       if(TIMx == ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000))) return ((uint8_t)0x01);
       else if(TIMx == ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000))) return ((uint8_t)0x01);
       else if(TIMx == ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))) return ((uint8_t)0x02);
       else if(TIMx == ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800))) return ((uint8_t)0x02);
       else if(TIMx == ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00))) return ((uint8_t)0x02);
       else if(TIMx == ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400))) return ((uint8_t)0x03);
       else if(TIMx == ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4000))) return ((uint8_t)0x03);
       else if(TIMx == ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4400))) return ((uint8_t)0x03);
       else if(TIMx == ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4800))) return ((uint8_t)0x03);
       else if(TIMx == ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1800))) return ((uint8_t)0x09);
       else if(TIMx == ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1C00))) return ((uint8_t)0x09);
       else return ((uint8_t)0x09);
}
...
void bsp_ConfigGpioOut(GPIO_TypeDef* GPIOx, uint16_t GPIO_PinX)
{
            ...
            TIM_TypeDef* TIMx, uint8_t _ucChannel,   uint32_t _ulFreq, uint32_t _ulDutyCycle)
    {
        ...
        {       
            ...
            GPIO_WriteBit(GPIOx, GPIO_Pin, (_ulDutyCycle == 0) ? Bit_SET : Bit_RESET);           
            return;
        }
        ...
        TIM_OCInitStructure.TIM_Pulse = (_ulDutyCycle * usPeriod)  / 100; 
