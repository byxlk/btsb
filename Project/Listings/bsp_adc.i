...
void bsp_InitADC(void)
{
      ...
      RCC_AHB1PeriphClockCmd(((uint32_t)0x00400000) | ((uint32_t)0x00000001), ENABLE);
      RCC_APB2PeriphClockCmd(((uint32_t)0x00000100), ENABLE);

       
      GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x0001) | ((uint16_t)0x0002) | ((uint16_t)0x0008);
      ...
      DMA_InitStructure.DMA_Channel = ((uint32_t)0x00000000);  
      DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)((u32)0x4001204C);
      ...
      DMA_InitStructure.DMA_PeripheralDataSize = ((uint32_t)0x00000800);
      DMA_InitStructure.DMA_MemoryDataSize = ((uint32_t)0x00002000);
      DMA_InitStructure.DMA_Mode = ((uint32_t)0x00000100);
      DMA_InitStructure.DMA_Priority = ((uint32_t)0x00020000);
      DMA_InitStructure.DMA_FIFOMode = ((uint32_t)0x00000000);  
      DMA_InitStructure.DMA_FIFOThreshold = ((uint32_t)0x00000001);
      DMA_InitStructure.DMA_MemoryBurst = ((uint32_t)0x00000000);
      DMA_InitStructure.DMA_PeripheralBurst = ((uint32_t)0x00000000);
      DMA_Init(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x010)), &DMA_InitStructure);
      DMA_Cmd(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x010)), ENABLE);
      ...
      ADC_CommonInitStructure.ADC_Mode = ((uint32_t)0x00000000);
      ADC_CommonInitStructure.ADC_Prescaler = ((uint32_t)0x00000000);
      ADC_CommonInitStructure.ADC_DMAAccessMode = ((uint32_t)0x00000000);
      ADC_CommonInitStructure.ADC_TwoSamplingDelay = ((uint32_t)0x00000000);
      ...
      ADC_Init(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000)), &ADC_InitStructure);

      
      ADC_DMACmd(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000)), ENABLE);
     
       
      ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000)), ((uint8_t)((uint8_t)0x10)), 1, ((uint8_t)0x07));
      ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000)), ((uint8_t)0x01), 2, ((uint8_t)0x07));
      ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000)), ((uint8_t)0x00), 3, ((uint8_t)0x00));
      ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000)), ((uint8_t)0x03), 4, ((uint8_t)0x07));

      ADC_TempSensorVrefintCmd(ENABLE);

      
      ADC_DMARequestAfterLastTransferCmd(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000)), ENABLE);
...
int8_t getCurent_ExtTempValue(void)
{
    ...
    Rtemp_Value = Vtemp_ExtSeneor * 20 * 100 / (3300 - Vtemp_ExtSeneor);
...
uint8_t getLightVLuxValue(void)
{
    uint32_t VLight_Sensor; 
    uint16_t ILight_Sensor; 
    uint8_t LightToLuxConvValue = 0; 
    
    VLight_Sensor = ADC_ConvertedValue[2] * 3300 / 4095;
    ILight_Sensor = (3300 - VLight_Sensor)  /2;
