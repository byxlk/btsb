...
#line 18 "..\\User\\bsp\\bsp_lcd_st7789v.c"
...
static volatile uint8_t s_RGBChgEn = 0;		 
...
#line 150 "..\\User\\bsp\\bsp_lcd_st7789v.c"
...
static void ST7789V_WriteCmd(uint8_t _ucCmd)
{
	*(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000))) = _ucCmd;	 
}
...
static void ST7789V_WriteParam(uint8_t _ucParam)
{
	*(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000)) + (1 << (0 + 1))) = _ucParam;
}
...
uint32_t ST7789V_ReadID(void)
{
	...
	*(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000))) = 0x04;
	buf[0] = *(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000)) + (1 << (0 + 1)));
	buf[1] = *(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000)) + (1 << (0 + 1)));
	buf[2] = *(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000)) + (1 << (0 + 1)));
	buf[3] = *(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000)) + (1 << (0 + 1)));
...
void ST7789V_ClrScr(uint16_t _usColor)
{
	...
	*(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000))) = 0x2C; 			 


	n = (g_LcdHeight * g_LcdWidth) / 8;
	for (i = 0; i < n; i++)
	{
		*(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000)) + (1 << (0 + 1))) = _usColor;
		*(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000)) + (1 << (0 + 1))) = _usColor;
		*(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000)) + (1 << (0 + 1))) = _usColor;
		*(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000)) + (1 << (0 + 1))) = _usColor;
...
#line 429 "..\\User\\bsp\\bsp_lcd_st7789v.c"
...
uint16_t ST7789V_GetPixel(uint16_t _usX, uint16_t _usY)
{
	...
	*(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000))) = 0x2E;
	R = *(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000)) + (1 << (0 + 1))); 	 
	R = *(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000)) + (1 << (0 + 1)));
	B = *(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000)) + (1 << (0 + 1)));
	G = *(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000)) + (1 << (0 + 1)));
...
void ST7789V_DrawHColorLine(uint16_t _usX1 , uint16_t _usY1, uint16_t _usWidth, const uint16_t *_pColor)
{
	...
	*(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000))) = 0x2C;
	...
	{
		*(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000)) + (1 << (0 + 1))) = *_pColor++;
	}
}
...
void ST7789V_DrawHTransLine(uint16_t _usX1 , uint16_t _usY1, uint16_t _usWidth, const uint16_t *_pColor)
{
	...
	*(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000))) = 0x2C;
	for (i = 0,j = 0; i < _usWidth; i++, j++)
	{
	    ...
	    if (Index)
        {
			 *(volatile uint16_t *)(((uint32_t)(0x6C000000 | 0x00000000)) + (1 << (0 + 1))) = Index;
		}
		else
		{
