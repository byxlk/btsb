#line 1 "..\\User\\bsp\\bsp_spi_flash.c"
...
#line 22 "..\\User\\bsp\\bsp_spi_flash.c"
...
#line 57 "..\\User\\bsp\\bsp_spi_flash.c"
...
#line 103 "..\\User\\bsp\\bsp_spi_flash.c"
...
#line 171 "..\\User\\bsp\\bsp_spi_flash.c"
 ...
 
	{
		...
		RCC_AHB1PeriphClockCmd(((uint32_t)0x00000002) | ((uint32_t)0x00000020), ENABLE);
		...
		GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), ((uint8_t)0x03), ((uint8_t)0x05));
		GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), ((uint8_t)0x04), ((uint8_t)0x05));
		GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), ((uint8_t)0x05), ((uint8_t)0x05));
		...
		((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400))->BSRRL = ((uint16_t)0x0100);		 
	...
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400))->BSRRH = ((uint16_t)0x0100);				 
	sf_SendByte(0x04);		 
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400))->BSRRL = ((uint16_t)0x0100);				 
...
static void bsp_CfgSPIForSFlash(void)
{
	...
	SPI_Cmd(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)), DISABLE);			 
...
void sf_EraseSector(uint32_t _uiSectorAddr)
{
	...
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400))->BSRRH = ((uint16_t)0x0100);									 
	sf_SendByte(0x20);								 
	sf_SendByte((_uiSectorAddr & 0xFF0000) >> 16);	 
	sf_SendByte((_uiSectorAddr & 0xFF00) >> 8);		 
	sf_SendByte(_uiSectorAddr & 0xFF);				 
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400))->BSRRL = ((uint16_t)0x0100);									 
...
void sf_PageWrite(uint8_t * _pBuf, uint32_t _uiWriteAddr, uint16_t _usSize)
{
	...
	if (g_tSF.ChipID == SST25VF016B_ID)
	{
		...
		((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400))->BSRRH = ((uint16_t)0x0100);									 
		sf_SendByte(0xAD);							 
		sf_SendByte((_uiWriteAddr & 0xFF0000) >> 16);	 
		sf_SendByte((_uiWriteAddr & 0xFF00) >> 8);		 
...
void sf_ReadBuffer(uint8_t * _pBuf, uint32_t _uiReadAddr, uint32_t _uiSize)
{
	...
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400))->BSRRH = ((uint16_t)0x0100);									 
	sf_SendByte(0x03);							 
	sf_SendByte((_uiReadAddr & 0xFF0000) >> 16);	 
	sf_SendByte((_uiReadAddr & 0xFF00) >> 8);		 
	sf_SendByte(_uiReadAddr & 0xFF);				 
	while (_uiSize--)
	{
		*_pBuf++ = sf_SendByte(0xA5);			 
	}
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400))->BSRRL = ((uint16_t)0x0100);									 
}
...
static uint8_t sf_CmpData(uint32_t _uiSrcAddr, uint8_t *_ucpTar, uint32_t _uiSize)
{
	...
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400))->BSRRH = ((uint16_t)0x0100);									 
	sf_SendByte(0x03);							 
	sf_SendByte((_uiSrcAddr & 0xFF0000) >> 16);		 
	sf_SendByte((_uiSrcAddr & 0xFF00) >> 8);		 
	sf_SendByte(_uiSrcAddr & 0xFF);					 
	while (_uiSize--)
	{
		 
		ucValue = sf_SendByte(0xA5);
		if (*_ucpTar++ != ucValue)
		{
			((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400))->BSRRL = ((uint16_t)0x0100);
			return 1;
...
uint32_t sf_ReadID(void)
{
	...
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400))->BSRRH = ((uint16_t)0x0100);									 
	sf_SendByte(0x9F);								 
	id1 = sf_SendByte(0xA5);					 
	id2 = sf_SendByte(0xA5);					 
	id3 = sf_SendByte(0xA5);					 
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400))->BSRRL = ((uint16_t)0x0100);									 
...
static uint8_t sf_SendByte(uint8_t _ucValue)
{
	...
	SPI_I2S_SendData(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)), _ucValue);
...
static void sf_WaitForWriteEnd(void)
{
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400))->BSRRH = ((uint16_t)0x0100);									 
	sf_SendByte(0x05);							 
	while((sf_SendByte(0xA5) & 0x01) == SET);	 
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400))->BSRRL = ((uint16_t)0x0100);									 
}
