...
void LCD_HardReset(void)
{
	...
	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0002));
	bsp_DelayMS(1);
	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0002));
	bsp_DelayMS(10);
	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0002));
 	bsp_DelayMS(120);
}
...
{
#line 511 "..\\User\\bsp\\bsp_tft_lcd.c"
		uint8_t *pDot = 0;
		uint8_t font_bytes = 0;
...
#line 917 "..\\User\\bsp\\bsp_tft_lcd.c"
}
...
#line 1267 "..\\User\\bsp\\bsp_tft_lcd.c"
}
...
#line 1337 "..\\User\\bsp\\bsp_tft_lcd.c"
...
#line 1396 "..\\User\\bsp\\bsp_tft_lcd.c"
}
...
#line 1519 "..\\User\\bsp\\bsp_tft_lcd.c"
}
...
static void LCD_CtrlLinesConfig(void)
{
	...
	RCC_APB2PeriphClockCmd(((uint32_t)0x00000002) | ((uint32_t)0x00000004), ENABLE);
...
#line 1688 "..\\User\\bsp\\bsp_tft_lcd.c"
...
void LCD_SetPwmBackLight(uint8_t _bright)
{
	...
	bsp_SetTIMOutPWM_N(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0004), ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), 3, 100, (_bright * 10000) /255);	
}
