...
void HardFault_Handler(void)
{
  ...
  for (i = 0; i < sizeof("\r\nEnter HardFault_Handler, System Halt.\r\n"); i++)
  {
     ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->DR = pError[i];
      
     while ((((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))->SR & ((uint16_t)0x0040)) == (uint16_t)RESET);
  }
