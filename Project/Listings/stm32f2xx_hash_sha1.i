#line 1 "..\\Libraries\\STM32F2xx_StdPeriph_Driver\\src\\stm32f2xx_hash_sha1.c"
...
#line 48 "..\\Libraries\\STM32F2xx_StdPeriph_Driver\\src\\stm32f2xx_hash_sha1.c"
...
ErrorStatus HASH_SHA1(uint8_t *Input, uint32_t Ilen, uint8_t Output[20])
{
  ...
  SHA1_HASH_InitStructure.HASH_AlgoSelection = ((uint16_t)0x0000);
  SHA1_HASH_InitStructure.HASH_AlgoMode = ((uint16_t)0x0000);
  SHA1_HASH_InitStructure.HASH_DataType = ((uint16_t)0x0020);
  ...
  do
  {
    busystatus = HASH_GetFlagStatus(((uint16_t)0x0008));
    counter++;
                      ...
                      uint32_t Ilen, uint8_t Output[20])
{
  ...
  SHA1_HASH_InitStructure.HASH_AlgoSelection = ((uint16_t)0x0000);
  SHA1_HASH_InitStructure.HASH_AlgoMode = ((uint16_t)0x0040);
  SHA1_HASH_InitStructure.HASH_DataType = ((uint16_t)0x0020);
  if(Keylen > 64)
  {
