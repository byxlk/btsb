#line 1 "..\\User\\emWinTask\\guitasktest.c"
...
#line 25 "..\\User\\emWinTask\\guitasktest.c"
#line 1 "..\\User\\emWinTask\\guitasktest.h"



#line 5 "..\\User\\emWinTask\\guitasktest.h"

void GuiTaskTest(void) ;
GUI_HWIN CreateWindow(void);
void bsp_RTC_Test(void);


#line 26 "..\\User\\emWinTask\\guitasktest.c"
...
#line 27 "..\\User\\emWinTask\\guitasktest.c"
...
#line 47 "..\\User\\emWinTask\\guitasktest.c"
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { WINDOW_CreateIndirect, "Window", (0x800 + 0x00), 0, 0, 240, 320, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "Test Programe Demo", (0x800 + 0x01), 66, 17, 105, 20, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "Temperature", (0x800 + 0x02), 16, 63, 80, 20, 0, 0x0, 0 },
  { EDIT_CreateIndirect, "tempvalue", (0x800 + 0x03), 106, 62, 80, 20, 0, 0x4, 0 },
  { TEXT_CreateIndirect, "Light Lux Value", (0x800 + 0x04), 16, 91, 80, 20, 0, 0x0, 0 },
  { EDIT_CreateIndirect, "lightlux", (0x800 + 0x05), 106, 90, 80, 20, 0, 0x3, 0 },
  { TEXT_CreateIndirect, "Mic dB Value", (0x800 + 0x06), 16, 119, 80, 20, 0, 0x0, 0 },
  { EDIT_CreateIndirect, "micdb", (0x800 + 0x07), 106, 118, 80, 20, 0, 0x4, 0 },
  { TEXT_CreateIndirect, "Date and Time:", (0x800 + 0x08), 9, 188, 80, 20, 0, 0x0, 0 },
  { EDIT_CreateIndirect, "dat", (0x800 + 0x09), 36, 219, 160, 20, 0, 0x64, 0 },
  { PROGBAR_CreateIndirect, "Progbar", (0x800 + 0x0A), 35, 263, 161, 20, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "MCU Temp Value", (0x800 + 0x0B), 17, 146, 80, 20, 0, 0x0, 0 },
  { EDIT_CreateIndirect, "mcutemp", (0x800 + 0x0C), 106, 145, 80, 20, 0, 0x3, 0 },
...
void GuiTaskTest(void) 
{
	...
	while(1) 
	{
		...
		ahProgBar = WM_GetDialogItem(hDlg, (0x800 + 0x0A));
		...
		PROGBAR_SetText(ahProgBar, acText);
                ...
                hEdit = WM_GetDialogItem(hDlg, (0x800 + 0x09));
                bsp_RTC_GetClock();
                ...
                {
                    hEdit = WM_GetDialogItem(hDlg, (0x800 + 0x03));
                    ExtTemp = ExtTemp /20;
                    mem_set(acText, 0x00, 5);
                    if(ExtTemp < 0)
                    {
                    ...
                    hEdit = WM_GetDialogItem(hDlg, (0x800 + 0x0C));
                    IntTemp = IntTemp /20;
                    mem_set(acText, 0x00, 5);
                    if (IntTemp < 100 )
                    {
                    ...
                    hEdit = WM_GetDialogItem(hDlg, (0x800 + 0x05));
                    ...
                    hEdit = WM_GetDialogItem(hDlg, (0x800 + 0x07));
                    Mic_dB = Mic_dB /20;
                    mem_set(acText, 0x00, 5);
                    if (Mic_dB < 100 )
                    {
...
#line 495 "..\\User\\emWinTask\\guitasktest.c"
