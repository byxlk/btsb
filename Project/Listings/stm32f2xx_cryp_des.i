...
#line 50 "..\\Libraries\\STM32F2xx_StdPeriph_Driver\\src\\stm32f2xx_cryp_des.c"
                         ...
                         uint32_t Ilength, uint8_t *Output)
{
  ...
  DES_CRYP_InitStructure.CRYP_AlgoMode = ((uint16_t)0x0010);
                         ...
                         uint8_t *Input, uint32_t Ilength, uint8_t *Output)
{
  ...
  DES_CRYP_InitStructure.CRYP_AlgoMode = ((uint16_t)0x0018);
  DES_CRYP_InitStructure.CRYP_DataType = ((uint16_t)0x0080);
  CRYP_Init(&DES_CRYP_InitStructure);
