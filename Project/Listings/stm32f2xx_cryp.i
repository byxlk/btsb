...
#line 335 "..\\Libraries\\STM32F2xx_StdPeriph_Driver\\inc\\stm32f2xx_cryp.h"
...
#line 166 "..\\Libraries\\STM32F2xx_StdPeriph_Driver\\src\\stm32f2xx_cryp.c"
#line 167 "..\\Libraries\\STM32F2xx_StdPeriph_Driver\\src\\stm32f2xx_cryp.c"
...
void CRYP_Init(CRYP_InitTypeDef* CRYP_InitStruct)
{
  ...
  ((CRYP_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x60000))->CR &= ~((uint32_t)0x00000038);
  ...
  if ((CRYP_InitStruct->CRYP_AlgoMode == ((uint16_t)0x0020)) ||
      (CRYP_InitStruct->CRYP_AlgoMode == ((uint16_t)0x0028)) ||
      (CRYP_InitStruct->CRYP_AlgoMode == ((uint16_t)0x0030)) ||
      (CRYP_InitStruct->CRYP_AlgoMode == ((uint16_t)0x0038)))
  {
    ((void)0);
...
void CRYP_StructInit(CRYP_InitTypeDef* CRYP_InitStruct)
{
  ...
  CRYP_InitStruct->CRYP_AlgoMode = ((uint16_t)0x0000);
                             ...
                             CRYP_KeyInitTypeDef* CRYP_KeyInitStruct)
{
  ...
  {      
    ...
    CRYP_ContextSave->CR_bits9to2  = ((CRYP_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x60000))->CR & (((uint32_t)0x00000300)  | 
                                                 ((uint32_t)0x000000C0) | 
                                                 ((uint32_t)0x00000038) |
                                                 ((uint32_t)0x00000004)); 
...
void CRYP_RestoreContext(CRYP_Context* CRYP_ContextRestore)  
{
  ...
  ((CRYP_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x60000))->CR = CRYP_ContextRestore->CR_bits9to2;
